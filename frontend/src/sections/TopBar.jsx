...
const TopBar = () => {
    ...
    return (
        <section className='w-full bg-[#4F4F4F]'>
            <div className='container h-[40px] text-white text-sm  flex justify-between items-center'>
                ...
                <div className='flex justify-center items-center text-gray-400'>
                    <button onClick={() => navigate('/sign_in')} className='flex justify-center items-center gap-1 border-l border-r border-gray-500 w-[100px] h-[40px] hover:cursor-pointer hover:text-white'>
                        <FaUser className='text-[12px]' />
                        <span >Đăng nhập</span>
                    </button>
                    <button onClick={() => navigate('/sign_up')} className='flex justify-center items-center gap-1 border-r border-gray-500 w-[100px] h-[40px] hover:cursor-pointer hover:text-white'>
