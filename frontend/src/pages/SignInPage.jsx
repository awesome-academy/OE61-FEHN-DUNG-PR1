            ...
            <div className='container'>
                ...
                <div className='grid grid-cols-2 gap-[50px]'>
                    ...
                    <div className='grid-cols-1'>
                        ...
                        <button onClick={() => navigate("/sign_up")} className='w-[200px] h-[50px] bg-green-600 hover:opacity-60 hover:cursor-pointer text-white flex justify-center items-center p-2 rounded-[20px] uppercase'>
                            đăng ký
                        </button>
                    </div>
                </div>
